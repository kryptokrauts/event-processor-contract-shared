...
-- Index for profile query
CREATE INDEX idx_soonmarket_realtime_event_data_buyer ON soonmarket_realtime_event ((data ->> 'buyer')); 
CREATE INDEX idx_soonmarket_realtime_event_data_seller ON soonmarket_realtime_event ((data ->> 'seller')); 
CREATE INDEX idx_soonmarket_realtime_event_data_from ON soonmarket_realtime_event ((data ->> 'from')); 
CREATE INDEX idx_soonmarket_realtime_event_data_to ON soonmarket_realtime_event ((data ->> 'to')); 
